...
// console.log(`o resultado de ${n} == ${u}: ${(n == u)} `)
// console.log(`o resultado de ${j} == ${J}: ${(j == J)} `)
...
// let eMaior = salarioA > salarioB
// let eMenor = salarioA < salarioB
// console.log(salarioA >= salarioB)
// console.log(salarioA <= salarioB)
// console.log(salarioA === salarioB)

// console.log(`Salário A ${salarioA} > ${salarioB}:  ${eMaior ? 'Sim' : 'Não'}`)
// console.log(`Salário A ${salarioA} < ${salarioB}:  ${eMenor ? 'Sim' : 'Não'}`)
// console.log(`Salário A ${salarioA} >= ${salarioB}:  ${salarioA >= salarioB ? 'Sim' : 'Não'}`)
// console.log(`Salário A ${salarioA} <= ${salarioB}:  ${salarioA <= salarioB ? 'Sim' : 'Não'}`)
// console.log(`Salário A ${salarioA} === ${salarioB}:  ${salarioA === salarioB ? 'Sim' : 'Não'}`)
...
// console.log(`Quantidade no estoque é > 0: ${estoque? 'Sim' : 'Não'}`)
// console.log(`Tem algo no estoque? ${temEstoque? 'Sim' : 'Não'}`)
// console.log(`O estoque está zerado? ${estoqueZerado? 'Sim' : 'Não'}`)
// console.log(`A temperatura é 36.6? ${temperatura? 'Sim' : 'Não'}`)
// console.log(`Para ser febre a temperatura tem que estar 37.6? ${febre? 'Sim': 'Não'}`)
