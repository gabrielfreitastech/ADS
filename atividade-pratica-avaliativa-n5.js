...
// Assunto já vistos anteriormente:
// Variáveis
...
// Operadores - Lógicos
// Estruturas de Controle - Condicionais: if + if else + else
// Estruturas de Controle - Condicionais: switch / case
// ============================================================
...
let orcamento = rl.questionInt('Deseja qual orcamento ? ')
let textoOrcamento = ''
    ...
    if (orcamento >= 1 && orcamento <= 3) {
        ...
        if (resp1 >= 1 && resp1 <= 3) {
            ...
            if ((resp1 === 1 || resp1 === 2 || resp1 === 3) && (resp2 >= 1 && resp2 <= 2)) {
                ...
                if ((resp1 === 1 && resp2 === 1 && resp3 >= 1 && resp3 <= 2) ||
                    (resp1 === 1 && resp2 === 2) ||
                    (resp1 === 2 && resp2 === 1 && resp3 >= 1 && resp3 <= 2) ||
                    (resp1 === 2 && resp2 === 2) ||
                    (resp1 === 3 && resp2 === 1 && resp3 >= 1 && resp3 <= 2) ||
                    (resp1 === 3 && resp2 === 2)) {
